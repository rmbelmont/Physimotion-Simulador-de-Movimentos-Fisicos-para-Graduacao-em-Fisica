...
Autor: Simulador Acadêmico
Versão: 2.0 - Modo Treinamento
================================================================================
"""
...
MOV = Namespace("http://www.simulador-fisica.org/ontologia#")
BASE = Namespace("http://www.simulador-fisica.org/")
...
class GeradorRelatorio:
    ...
    def gerar_relatorio_academico(pasta_destino, dados_experimento, caminho_grafico, formula_data, resultados):
        ...
        nome_arquivo = f"relatorio_academico_{dados_experimento['tipo']}_{timestamp}.html"
...
<head>
    ...
    <title>Relatório Acadêmico - {formula_data['nome']}</title>
    <style>
        * {{
            margin: 0;
            padding: 0;
...
<body>
    <div class="paper">
        <div class="header">
            <h1>📊 RELATÓRIO ACADÊMICO DE FÍSICA</h1>
            <div class="subtitle">Análise do Movimento: {formula_data['nome']}</div>
            <p style="margin-top: 10px; font-size: 0.9em;">{formula_data['nome_latim']}</p>
...
"""
        ...
        html_content += f"""
            ...
            <div class="reference">
                ...
                TIPLER, Paul A.; MOSCA, Gene. Física para Cientistas e Engenheiros. 6. ed. Rio de Janeiro: LTC, 2014.
            </div>
        </div>
        
        <div class="footer">
            <p>📚 Relatório gerado pelo Simulador de Movimentos Físicos - Treinamento para Graduação</p>
            <p>🏷️ Ontologia RDF: {os.path.basename(dados_experimento.get('ontologia', 'ontologia_movimentos.rdf'))}</p>
            <p>© {datetime.now().year} - Laboratório de Física Computacional</p>
        </div>
    </div>
</body>
</html>
"""
    ...
    def _obter_unidade_resultado(key):
        unidades = {
            ...
            'alcance': 'm', 'altura_maxima': 'm', 'tempo_voo': 's'
        }
        return unidades.get(key, '')

# ==================== INTERFACE PRINCIPAL - MODO TREINAMENTO ====================
class AppMovimentos:
    def __init__(self, root):
        self.root = root
        self.root.title("Simulador de Movimentos Físicos - Treinamento para Graduação em Física")
    ...
    def setup_estilo(self):
        ...
        # Configurar cores
        style.configure("Title.TLabel", font=('Segoe UI', 16, 'bold'), foreground='#1a3e60')
        style.configure("Subtitle.TLabel", font=('Segoe UI', 10), foreground='#666')
        style.configure("Success.TButton", font=('Segoe UI', 10, 'bold'), background='#27ae60')
        style.configure("Primary.TButton", font=('Segoe UI', 10, 'bold'), background='#3498db')
        style.configure("Warning.TButton", font=('Segoe UI', 10, 'bold'), background='#e67e22')
        
        # Frame com borda
        style.configure("Card.TFrame", background='white', relief='raised', borderwidth=1)
        style.configure("Card.TLabelframe", background='white', relief='raised', borderwidth=1)
        style.configure("Card.TLabelframe.Label", background='white', foreground='#1a3e60', font=('Segoe UI', 11, 'bold'))
    ...
    def setup_interface(self):
        ...
        ttk.Label(header_frame, text="🎓 SIMULADOR DE MOVIMENTOS FÍSICOS", style="Title.TLabel").pack(pady=(15,5))
        ttk.Label(header_frame, text="Treinamento para Estudantes de Graduação em Física", style="Subtitle.TLabel").pack()
        ttk.Label(header_frame, text="Explore, visualize e compreenda os fundamentos da Mecânica Clássica", style="Subtitle.TLabel").pack(pady=(0,15))
        ...
        ttk.Button(btn_frame, text="📄 GERAR RELATÓRIO ACADÊMICO", command=self.gerar_relatorio, style="Primary.TButton").pack(fill=tk.X, pady=3)
        ...
        center_frame = ttk.LabelFrame(content_frame, text="📊 VISUALIZAÇÃO 3D", style="Card.TLabelframe", padding="10")
    ...
    def atualizar_info(self, params, t_total, formula_data, alcance, altura_max, resultados):
        ...
        self.info_text.insert(tk.END, "📊 RESULTADOS NUMÉRICOS\n")
        self.info_text.insert(tk.END, "═"*45 + "\n\n")
    ...
    def gerar_relatorio(self):
        ...
        messagebox.showinfo("Sucesso", f"📄 Relatório acadêmico gerado com sucesso!\n\nArquivo: {caminho_relatorio}\n\nO relatório será aberto no navegador.")
    ...
    def mostrar_historico(self):
        ...
        hist_window.title("📋 Histórico de Experimentos - Treinamento")
    ...
    def resetar(self):
        ...
        self.ax.set_title('Simulador de Movimentos Físicos')
        self.ax.grid(True, alpha=0.3)
        self.canvas.draw()
        self.info_text.delete(1.0, tk.END)
...
if __name__ == "__main__":
    print("="*80)
    print("🎓 SIMULADOR DE MOVIMENTOS FÍSICOS - TREINAMENTO PARA GRADUAÇÃO EM FÍSICA")
    print("="*80)
    print("\n📌 Funcionalidades do Modo Treinamento:")
    print("   ✅ Interface profissional com design acadêmico")
    ...
    print("   ✅ Relatórios acadêmicos em formato HTML com referências")
